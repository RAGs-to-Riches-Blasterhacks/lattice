...
class RoadmapNodeCard extends StatelessWidget {
  ...
  Widget _resourceIcon(ResourceType type, double size) {
    final (IconData icon, Color color) = switch (type) {
      ResourceType.youtube => (Icons.smart_display_rounded, AppColors.iconYoutube),
      ...
      ResourceType.exercise => (Icons.fitness_center_rounded, AppColors.iconExercise),
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ..._uniqueResourceTypes.map((t) => _resourceIcon(t, iconSize)),
                      ],
                    ),
